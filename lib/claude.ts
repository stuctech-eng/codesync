...
- **Als de gebruiker een concrete codewijziging vraagt** (bijv. "pas X aan", "fix deze bug", "voeg Y toe"): lees eerst de relevante bestanden, bepaal de exacte wijziging, en roep dan prepare_changeset aan met de volledige nieuwe inhoud van elk gewijzigd bestand. Leg in 'explanation' kort uit wat en waarom.
